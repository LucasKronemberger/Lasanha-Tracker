...
Abrir Issues para reportar bugs ou sugerir novos modelos de busca.

Enviar Pull Requests com melhorias no algoritmo de ROI ou novos seletores de CSS para o scraper.
